...
const CalcButton = ({ rawBtnVal, calcType = calcTypes.operandType }: props) => {
  ...
  return (
    <>
      {rawBtnVal === "=" && (
        <div
          className="calc-button-eq flex justify-center items-center w-full rounded-xs bg-linear-to-b from-indigo-100 hover:from-indigo-200 active:from-indigo-300 dark:from-indigo-700 dark:hover:from-indigo-600 dark:active:from-indigo-500 to-indigo-200 hover:to-indigo-300 active:to-indigo-400 dark:to-indigo-600 dark:hover:to-indigo-500 dark:active:to-indigo-400 font-semibold select-none cursor-pointer"
          onClick={handleClick}
          title={handleTooltip()}
        >
          {handleButtonDisplay()}
      ...
      {rawBtnVal !== "=" && (
        <div
          ...
          w-full rounded-xs bg-linear-to-b from-slate-100 hover:from-slate-200 active:from-slate-300 dark:from-slate-700 dark:hover:from-slate-600 dark:active:from-slate-500 to-slate-200 hover:to-slate-300 active:to-slate-400 dark:to-slate-600 dark:hover:to-slate-500 dark:active:to-slate-400 font-semibold select-none cursor-pointer"
          onClick={handleClick}
          title={handleTooltip()}
        >
          {handleButtonDisplay()}
